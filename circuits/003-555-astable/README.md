...
|---|-----|-----|---------|
| 1 | VCC (+5 V) | RA 上端 | `VCC` |
| 2 | RA 下端 | XU1 引脚 7（DIS） | `DIS` |
| 3 | XU1 引脚 7（DIS） | RB 左端 | `DIS` |
| 4 | RB 右端 | XU1 引脚 6（THR） | `THR` |
| 5 | XU1 引脚 6（THR） | XU1 引脚 2（TRIG） | `THR`（**关键短接**） |
| 6 | `THR` 节点 | CT 上端 | `THR` |
| 7 | CT 下端 | GND | — |
| 8 | XU1 引脚 5（CTRL） | CC 上端 | `CTRL` |
| 9 | CC 下端 | GND | — |
| 10 | VCC (+5 V) | RPU 上端 | `VCC` |
| 11 | RPU 下端 | XU1 引脚 4（RESET） | `RESET` |
| 12 | XU1 引脚 8（VCC） | VCC (+5 V) | `VCC` |
| 13 | XU1 引脚 1（GND） | GND | — |
| 14 | XU1 引脚 3（OUT） | RL 上端 | `OUT` |
| 15 | RL 下端 | GND | — |
| 16 | XSC1 CH B `+` | `OUT` | `OUT` |
| 17 | XSC1 CH B `-` | GND | — |
